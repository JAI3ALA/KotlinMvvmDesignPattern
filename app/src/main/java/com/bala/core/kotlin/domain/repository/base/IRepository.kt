package com.bala.core.kotlin.domain.repository.base

import com.bala.core.kotlin.common.logger.Logger
import com.bala.core.kotlin.domain.remote.response.ApiResponse
import com.bala.core.kotlin.domain.remote.response.ErrorCode
    ...
    suspend fun <T> handleRequest(call: suspend () -> Response<T>): ApiResponse<T> {
        return try {
            ...
            if (apiResponse.isSuccessful) {
                ApiResponse.SuccessNew(apiResponse.body())
            } else {
